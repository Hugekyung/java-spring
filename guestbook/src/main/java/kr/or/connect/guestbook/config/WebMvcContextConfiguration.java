...
@Configuration
@EnableWebMvc
@ComponentScan(basePackages = { "kr.or.connect.guestbook.controller" }) // basePackages는 항상 설정해줘야 한다.
public class WebMvcContextConfiguration extends WebMvcConfigurerAdapter {
    ...
    // default servlet handler를 사용하게 합니다. configureDefaultServletHandling는 매핑정보가 없는 url를 처리하는 것.
    @Override
